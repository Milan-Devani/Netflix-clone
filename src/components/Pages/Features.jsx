      ...
      <svg width="72" height="72" viewBox="0 0 72 72" fill="none">
        ...
        <defs>
          ...
          <radialGradient
            ...
            r="1"
            gradientUnits="userSpaceOnUse"
            gradientTransform="translate(43.9648 27.2695) rotate(112.479) scale(17.7224 38.1491)"
          >
            <stop stopColor="#00A3FF" />
            <stop offset="0.507469" stopColor="#F7AF0F" />
          ...
          <radialGradient
            ...
            r="1"
            gradientUnits="userSpaceOnUse"
            gradientTransform="translate(34.9573 47.1211) rotate(90) scale(6.37885)"
          >
            <stop stopColor="#9C1E1E" />
            <stop offset="1" stopColor="#801E9C" />
          </radialGradient>
        </defs>
      </svg>
    ),
...
const Features = () => {
  return (
    <div className="bg-black text-white py-16 px-[9.25rem]">
      <h2 className="text-3xl font-semibold mb-8">More reasons to join</h2>
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        {featuresData.map((feature, index) => (
          <div key={index} className="bg-Features-gradient p-4 rounded-[1rem]">
            <h3 className="text-xl text-white font-semibold mb-4">
              {feature.title}
            </h3>
            <p className="mb-6 font-NetflixSans_Md text-[#ffffffb3]">
              {feature.description}
            </p>
